...
- tutorial https://github.com/talwrii/ffmpeg-cookbook
...
- [0x|#]RRGGBB[AA]
- some defined color names (case insensitive)
  - "random"
- alpha
  - 0 transparent
  - 1 opaque
...
(+metadata) https://trac.ffmpeg.org/wiki/FilteringGuide
...
** expression to overlay at center
...
|--------------+---------------------------------------------+------------------|
| -vf          | scale=64x64                                 | downscale        |
|              | xfade=transition=fade:duration=2.5:offset=5 |                  |
|              | fps=30                                      |                  |
|              | blend='hardlight'                           |                  |
|              | datascope=mode='color'                      |                  |
|              | displace                                    |                  |
|              | format=rgb24                                |                  |
|--------------+---------------------------------------------+------------------|
| -qp          | 40                                          | quantization     |
...
|--------------+---------------------------------------------+------------------|
| -c:v         | libx264                                     | H264             |
| -x264-params | keyint=10¦5000                              |                  |
|              | keyint_min=10¦5000                          |                  |
|              | bframes=0                                   |                  |
|--------------+---------------------------------------------+------------------|
| -pix_fmt     | yuv420p                                     |                  |
|--------------+---------------------------------------------+------------------|
| -bsf:v       | noise=amount='3000*not(key)'                | bitstream filter |
| -bsf:a       | noise=amount='10'                           |                  |
|--------------+---------------------------------------------+------------------|
** from frames
